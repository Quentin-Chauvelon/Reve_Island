...
function VehicleGui:Enable(Seat, Key)
	local HazardsLightsOn = function()
		while HazardsLights == true do
			self.car.Body.FrontLeftIndicator.Transparency = 0
			self.car.Body.FrontRightIndicator.Transparency = 0
			self.car.Body.BackLeftIndicator.Transparency = 0
			self.car.Body.BackRightIndicator.Transparency = 0
			wait(0.5)
			self.car.Body.FrontLeftIndicator.Transparency = 0.5
			self.car.Body.FrontRightIndicator.Transparency = 0.5
			self.car.Body.BackLeftIndicator.Transparency = 0.5
			self.car.Body.BackRightIndicator.Transparency = 0.5
			wait(0.5)
		end
	end
	...
	if not Key then
		...
		local function UpdateInputType(inputType)
			...
			elseif inputType == Enum.UserInputType.Keyboard then
				self:EnableKeyboardUI()
				if LocalPlayer.Settings.DisplayVehicleKeyHelp.Value == true then
