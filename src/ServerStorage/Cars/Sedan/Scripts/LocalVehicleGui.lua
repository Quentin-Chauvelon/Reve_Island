...
function VehicleGui:Enable(Seat, Key)
	local HazardsLightsOn = function()
		while HazardsLights == true do
			...
			--wait(0.5)
			self.car.Body.Headlights.Transparency = 0.2
			self.car.Body.TailLights.Transparency = 0.2
			wait(0.5)
			self.car.Body.Headlights.Transparency = 0
			self.car.Body.TailLights.Transparency = 0
			wait(0.5)
		end
	end
