						...
						if Player.Character ~= nil then
							...
							if HRP then
								...
								if Dist <= MAX_SEATING_DISTANCE then
									...
									--local StandingAnimation = "http://www.roblox.com/asset/?id=507766388"
									--humanoid.Animator:LoadAnimation(script.Animation):Play()
									
									if not SkateBoardAnimation then
										SkateBoardAnimation = humanoid.Animator:LoadAnimation(script.SkateBoardAnimation)
									end
									
									if SkateBoardAnimation then
										SkateBoardAnimation:Play()
										SkateBoardAnimation:AdjustSpeed(0)
									end
									...
									--	print(track, script.SkateBoardAnimation, track == script.SkateBoardAnimation)
									--	if track == script.SkateBoardAnimation then
									--		SkateBoardAnimation = track
									--		print("found")
									--	end
									--end
